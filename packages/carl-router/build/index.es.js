...
function useHistory() {
  if (process.env.NODE_ENV !== "production") {
    !(typeof useContext$1 === "function") ? process.env.NODE_ENV !== "production" ? invariant(false, "You must use React >= 16.8 in order to use useHistory()") : invariant(false) : void 0;
  }

  return useContext$1(context).history;
}
function useLocation() {
  if (process.env.NODE_ENV !== "production") {
    !(typeof useContext$1 === "function") ? process.env.NODE_ENV !== "production" ? invariant(false, "You must use React >= 16.8 in order to use useLocation()") : invariant(false) : void 0;
  }

  return useContext$1(context).location;
}
function useParams() {
  if (process.env.NODE_ENV !== "production") {
    !(typeof useContext$1 === "function") ? process.env.NODE_ENV !== "production" ? invariant(false, "You must use React >= 16.8 in order to use useParams()") : invariant(false) : void 0;
  }

  var match = useContext$1(context).match;
  return match ? match.params : {};
}
function useRouteMatch(path) {
  if (process.env.NODE_ENV !== "production") {
    !(typeof useContext$1 === "function") ? process.env.NODE_ENV !== "production" ? invariant(false, "You must use React >= 16.8 in order to use useRouteMatch()") : invariant(false) : void 0;
  }

  return path ? matchPath(useLocation().pathname, path) : useContext$1(context).match;
}
 ...
 */
var wrap = function (routes) { return routes.map(function (route) {
    var Comp = route.component;
    if (Comp) {
        return __assign(__assign({}, route), { routes: wrap(route.routes || []), component: function (props) {
                return (react.createElement(Comp, __assign({}, props),
                    react.createElement(Switch, null, renderRoutes(props.route.routes))));
            } });
    }
    else {
        return route;
...
var render = (function (routes) { return withRouter(function () { return (react.createElement(Switch, null, renderRoutes(wrap(routes)))); }); });

export { reactRouter as RouterCore, reactRouterDom as RouterDom, render, wrap };
